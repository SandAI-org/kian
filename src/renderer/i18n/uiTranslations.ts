...
const EN_US_EXACT: Record<string, string> = {
  ...
  "立即重启并升级": "Restart and upgrade now",
  "更新日志": "Changelog",
  "暂无更新说明": "No release notes available",
  "稍后": "Later",
  "Debug": "Debug",
  "会话调试": "Session Debug",
  "显示隐藏的 session": "Show hidden sessions",
  "开启后，对话列表会显示隐藏 session，便于调试群聊 runtime。":
    "When enabled, chat lists show hidden sessions for debugging group chat runtime.",
  "隐藏": "Hidden",
  "调试选项已更新": "Debug option updated",
  "保存调试选项失败": "Failed to save debug option",
  "升级调试": "Update Debug",
  "仅开发环境可见": "Only visible in development",
  "模拟版本号": "Mock version",
  "更新日志 Markdown": "Changelog Markdown",
  "模拟未检查": "Mock not checked",
  "模拟检查中": "Mock checking",
  "模拟发现新版本": "Mock update found",
  "模拟下载中": "Mock downloading",
  "模拟已下载": "Mock downloaded",
  "模拟已是最新": "Mock up to date",
  "模拟失败": "Mock failed",
  "升级状态已模拟": "Update state mocked",
  "模拟升级状态失败": "Failed to mock update state",
  "已模拟重启并升级": "Restart and upgrade mocked",
  "升级调试仅开发环境可用":
    "Update debug is only available in development",
  "## 更新内容\n\n- 这是一个用于本地调试的更新日志。":
    "## What's Changed\n\n- This is a local debug changelog.",
  "新版本": "New",
  "通用": "General",
  "快捷键": "Shortcuts",
  ...
  "在新对话中继续": "Continue in New Chat",
  "在新对话中继续失败": "Failed to continue in a new chat",
  "编辑消息": "Edit message",
  ...
  "删除": "Delete",
  "关闭": "Close",
  "订阅登录": "Subscription Login",
  "已登录": "Logged in",
  "退出登录": "Log out",
  "登录订阅账号": "Log in with subscription",
  "使用 Claude Pro/Max 订阅额度调用模型，无需 API Key。":
    "Use your Claude Pro/Max subscription to call models — no API key required.",
  "使用 ChatGPT Plus/Pro 订阅额度调用 Codex 模型，无需 API Key。":
    "Use your ChatGPT Plus/Pro subscription to call Codex models — no API key required.",
  "订阅登录成功": "Subscription login successful",
  "登录失败": "Login failed",
  "授权码提交失败": "Failed to submit authorization code",
  "已退出订阅登录": "Logged out of subscription",
  "退出登录失败": "Failed to log out",
  "正在准备授权页面...": "Preparing the authorization page...",
  "已在浏览器打开授权页面，请完成登录并授权。":
    "The authorization page has been opened in your browser. Complete the login and authorization there.",
  "浏览器没有自动打开时，可复制上方链接手动访问。授权完成后此窗口会自动关闭；如果授权页面提供了授权码，也可以粘贴到下方提交。":
    "If the browser didn't open automatically, copy the link above and visit it manually. This window closes automatically once authorization completes; if the page shows an authorization code, you can also paste it below.",
  "粘贴授权码（可选）": "Paste authorization code (optional)",
  "重试": "Retry",
  "提交": "Submit",
  "开启": "Enable",
  "暂停": "Pause",
  ...
  "松开鼠标，复制文件到文档中。":
    "Release to copy files into Docs.",
  ...
  "选择一个 Agent 或群组开始": "Select an agent or group to start",
  "创建群组或者智能体来聊天吧": "Create a group or agent to start chatting",
  "群组名称": "Group Name",
  "请输入群组名称": "Enter a group name",
  "群组描述": "Group Description",
  "添加成员": "Add Members",
  "添加群成员": "Add Group Members",
  "成员": "Members",
  "群成员": "Group Members",
  "选择要加入的 Agent": "Select agents to add",
  "可添加 Agent": "Available Agents",
  "已选择 Agent": "Selected Agents",
  "暂无可添加 Agent": "No agents available",
  "尚未选择 Agent": "No agents selected",
  "选择全部可添加 Agent": "Select all available agents",
  "选择全部已选择 Agent": "Select all selected agents",
  "添加选中的 Agent": "Add selected agents",
  "取消选择选中的 Agent": "Deselect selected agents",
  "添加成员失败": "Failed to add members",
  "移除成员": "Remove Member",
  "移除成员失败": "Failed to remove member",
  "还没有群成员": "No group members yet",
  "暂无群消息": "No group messages yet",
  "加载群消息失败": "Failed to load group messages",
...
const KO_KR_EXACT: Record<string, string> = {
  ...
  "Debug": "디버그",
  "会话调试": "세션 디버그",
  "显示隐藏的 session": "숨겨진 세션 표시",
  "开启后，对话列表会显示隐藏 session，便于调试群聊 runtime。":
    "켜면 대화 목록에 숨겨진 세션이 표시되어 그룹 채팅 런타임을 디버그할 수 있습니다.",
  "隐藏": "숨김",
  "调试选项已更新": "디버그 옵션이 업데이트되었습니다",
  "保存调试选项失败": "디버그 옵션 저장 실패",
  "升级调试": "업데이트 디버그",
  "仅开发环境可见": "개발 환경에서만 표시됩니다",
  "模拟版本号": "모의 버전",
  "更新日志 Markdown": "변경 로그 Markdown",
  "模拟未检查": "확인 전으로 모의",
  "模拟检查中": "확인 중으로 모의",
  "模拟发现新版本": "새 버전 발견 모의",
  "模拟下载中": "다운로드 중으로 모의",
  ...
  "模拟已是最新": "최신 상태 모의",
  "模拟失败": "실패 상태 모의",
  "升级状态已模拟": "업데이트 상태를 모의했습니다",
  "模拟升级状态失败": "업데이트 상태 모의 실패",
  "已模拟重启并升级": "재시작 및 업그레이드를 모의했습니다",
  "升级调试仅开发环境可用":
    "업데이트 디버그는 개발 환경에서만 사용할 수 있습니다",
  "## 更新内容\n\n- 这是一个用于本地调试的更新日志。":
    "## 변경 내용\n\n- 로컬 디버그용 변경 로그입니다.",
  "新版本": "새 버전",
  "通用": "일반",
  ...
  "登录订阅账号": "구독 계정으로 로그인",
  "使用 Claude Pro/Max 订阅额度调用模型，无需 API Key。":
    "Claude Pro/Max 구독으로 모델을 호출합니다. API Key가 필요 없습니다.",
  "使用 ChatGPT Plus/Pro 订阅额度调用 Codex 模型，无需 API Key。":
    "ChatGPT Plus/Pro 구독으로 Codex 모델을 호출합니다. API Key가 필요 없습니다.",
  "订阅登录成功": "구독 로그인 성공",
  "登录失败": "로그인 실패",
  "授权码提交失败": "인증 코드 제출 실패",
  "已退出订阅登录": "구독 로그인에서 로그아웃했습니다",
  "退出登录失败": "로그아웃 실패",
  "正在准备授权页面...": "인증 페이지를 준비하는 중...",
  "已在浏览器打开授权页面，请完成登录并授权。":
    "브라우저에서 인증 페이지가 열렸습니다. 로그인과 인증을 완료해 주세요.",
  "浏览器没有自动打开时，可复制上方链接手动访问。授权完成后此窗口会自动关闭；如果授权页面提供了授权码，也可以粘贴到下方提交。":
    "브라우저가 자동으로 열리지 않으면 위 링크를 복사해 직접 접속하세요. 인증이 완료되면 이 창은 자동으로 닫힙니다. 인증 페이지에 코드가 표시되면 아래에 붙여넣어 제출할 수도 있습니다.",
  "粘贴授权码（可选）": "인증 코드 붙여넣기 (선택)",
  "重试": "다시 시도",
  "提交": "제출",
  "开启": "사용",
  "暂停": "일시 중지",
  ...
  "新文件夹": "새 폴더",
  "文件已导入": "파일을 가져왔습니다",
  "导入文件失败": "파일 가져오기에 실패했습니다",
  "松开鼠标，复制文件到文档中。":
    "마우스를 놓으면 파일이 문서로 복사됩니다.",
  "自动保存失败": "자동 저장 실패",
  "保存图片到剪贴板": "이미지를 클립보드에 저장",
  "图片已保存到剪贴板": "이미지를 클립보드에 저장했습니다",
  "保存图片到剪贴板失败": "이미지를 클립보드에 저장하지 못했습니다",
  "飞书": "Feishu",
  "企业微信": "WeCom",
  "聊天": "채팅",
  "数字分身": "디지털 아바타",
  ...
  "全部 Agent": "모든 에이전트",
  "群组": "그룹",
  "暂无 Agent": "아직 에이전트가 없습니다",
  "新建群组": "새 그룹",
  "暂无群组": "아직 그룹이 없습니다",
  "创建群组失败": "그룹 생성 실패",
  "群组已删除": "그룹을 삭제했습니다",
  "删除群组失败": "그룹 삭제 실패",
  "选择一个 Agent 或群组开始": "시작할 에이전트 또는 그룹을 선택하세요",
  "创建群组或者智能体来聊天吧": "그룹이나 에이전트를 만들어 대화를 시작하세요",
  "群组名称": "그룹 이름",
  "请输入群组名称": "그룹 이름을 입력하세요",
  "群组描述": "그룹 설명",
  "添加成员": "멤버 추가",
  "添加群成员": "그룹 멤버 추가",
  "成员": "멤버",
  "群成员": "그룹 멤버",
  "选择要加入的 Agent": "추가할 에이전트를 선택하세요",
  "可添加 Agent": "추가 가능한 에이전트",
  "已选择 Agent": "선택된 에이전트",
  "暂无可添加 Agent": "추가 가능한 에이전트가 없습니다",
  "尚未选择 Agent": "아직 선택한 에이전트가 없습니다",
  "选择全部可添加 Agent": "추가 가능한 에이전트 모두 선택",
  "选择全部已选择 Agent": "선택된 에이전트 모두 선택",
  "添加选中的 Agent": "선택한 에이전트 추가",
  "取消选择选中的 Agent": "선택한 에이전트 선택 취소",
  "添加成员失败": "멤버 추가 실패",
  "移除成员": "멤버 제거",
  "移除成员失败": "멤버 제거 실패",
  "还没有群成员": "아직 그룹 멤버가 없습니다",
  "暂无群消息": "아직 그룹 메시지가 없습니다",
  "加载群消息失败": "그룹 메시지를 불러오지 못했습니다",
  "加载更早消息": "이전 메시지 불러오기",
...
const JA_JP_EXACT: Record<string, string> = {
  ...
  "更新日志": "変更履歴",
  "暂无更新说明": "リリースノートはありません",
  "稍后": "後で",
  "Debug": "デバッグ",
  "会话调试": "セッションデバッグ",
  "显示隐藏的 session": "非表示セッションを表示",
  "开启后，对话列表会显示隐藏 session，便于调试群聊 runtime。":
    "有効にすると、チャット一覧に非表示セッションが表示され、グループチャット runtime のデバッグに使えます。",
  "隐藏": "非表示",
  "调试选项已更新": "デバッグオプションを更新しました",
  "保存调试选项失败": "デバッグオプションの保存に失敗しました",
  "升级调试": "アップデートデバッグ",
  "仅开发环境可见": "開発環境でのみ表示されます",
  "模拟版本号": "モックバージョン",
  "更新日志 Markdown": "変更履歴 Markdown",
  "模拟未检查": "未確認をモック",
  "模拟检查中": "確認中をモック",
  "模拟发现新版本": "新バージョン検出をモック",
  "模拟下载中": "ダウンロード中をモック",
  "模拟已下载": "ダウンロード済みをモック",
  "模拟已是最新": "最新状態をモック",
  "模拟失败": "失敗をモック",
  "升级状态已模拟": "アップデート状態をモックしました",
  "模拟升级状态失败": "アップデート状態のモックに失敗しました",
  "已模拟重启并升级": "再起動とアップグレードをモックしました",
  "升级调试仅开发环境可用":
    "アップデートデバッグは開発環境でのみ使用できます",
  "## 更新内容\n\n- 这是一个用于本地调试的更新日志。":
    "## 変更内容\n\n- ローカルデバッグ用の変更履歴です。",
  "新版本": "新規",
  "通用": "一般",
  ...
  "已登录": "ログイン済み",
  "退出登录": "ログアウト",
  "登录订阅账号": "サブスクリプションでログイン",
  "使用 Claude Pro/Max 订阅额度调用模型，无需 API Key。":
    "Claude Pro/Max のサブスクリプションでモデルを呼び出します。API Key は不要です。",
  "使用 ChatGPT Plus/Pro 订阅额度调用 Codex 模型，无需 API Key。":
    "ChatGPT Plus/Pro のサブスクリプションで Codex モデルを呼び出します。API Key は不要です。",
  "订阅登录成功": "サブスクリプションログインに成功しました",
  "登录失败": "ログインに失敗しました",
  "授权码提交失败": "認証コードの送信に失敗しました",
  "已退出订阅登录": "サブスクリプションからログアウトしました",
  "退出登录失败": "ログアウトに失敗しました",
  "正在准备授权页面...": "認証ページを準備しています...",
  "已在浏览器打开授权页面，请完成登录并授权。":
    "ブラウザで認証ページを開きました。ログインと認証を完了してください。",
  "浏览器没有自动打开时，可复制上方链接手动访问。授权完成后此窗口会自动关闭；如果授权页面提供了授权码，也可以粘贴到下方提交。":
    "ブラウザが自動で開かない場合は、上のリンクをコピーして手動でアクセスしてください。認証が完了するとこのウィンドウは自動的に閉じます。認証ページにコードが表示された場合は、下に貼り付けて送信することもできます。",
  "粘贴授权码（可选）": "認証コードを貼り付け（任意）",
  "重试": "再試行",
  "提交": "送信",
  "开启": "有効化",
  "暂停": "一時停止",
  ...
  "新文件.md": "新規ファイル.md",
  "新文件夹": "新規フォルダ",
  "文件已导入": "ファイルをインポートしました",
  "导入文件失败": "ファイルのインポートに失敗しました",
  "松开鼠标，复制文件到文档中。":
    "マウスを離すとファイルをドキュメントにコピーします。",
  "自动保存失败": "自動保存に失敗しました",
  "保存图片到剪贴板": "画像をクリップボードに保存",
  "图片已保存到剪贴板": "画像をクリップボードに保存しました",
  "保存图片到剪贴板失败": "画像をクリップボードに保存できませんでした",
  "飞书": "Feishu",
  "企业微信": "WeCom",
  "聊天": "チャット",
  "数字分身": "デジタルアバター",
  ...
  "全部 Agent": "すべてのエージェント",
  "群组": "グループ",
  "暂无 Agent": "エージェントはまだありません",
  "新建群组": "新しいグループ",
  "暂无群组": "グループはまだありません",
  "创建群组失败": "グループの作成に失敗しました",
  "群组已删除": "グループを削除しました",
  "删除群组失败": "グループの削除に失敗しました",
  "选择一个 Agent 或群组开始": "開始するエージェントまたはグループを選択してください",
  "创建群组或者智能体来聊天吧": "グループまたはエージェントを作成してチャットしましょう",
  "群组名称": "グループ名",
  ...
  "成员": "メンバー",
  "群成员": "グループメンバー",
  "选择要加入的 Agent": "追加するエージェントを選択",
  "可添加 Agent": "追加可能なエージェント",
  "已选择 Agent": "選択済みエージェント",
  "暂无可添加 Agent": "追加可能なエージェントはありません",
  "尚未选择 Agent": "エージェントがまだ選択されていません",
  "选择全部可添加 Agent": "追加可能なエージェントをすべて選択",
  "选择全部已选择 Agent": "選択済みエージェントをすべて選択",
  "添加选中的 Agent": "選択したエージェントを追加",
  "取消选择选中的 Agent": "選択したエージェントを解除",
  "添加成员失败": "メンバーの追加に失敗しました",
  "移除成员": "メンバーを削除",
  "移除成员失败": "メンバーの削除に失敗しました",
  "还没有群成员": "グループメンバーはまだいません",
  "暂无群消息": "グループメッセージはまだありません",
  "加载群消息失败": "グループメッセージの読み込みに失敗しました",
...
const EXTRA_EXACT_TRANSLATIONS: Record<AppLanguage, Record<string, string>> = {
  ...
  "修改对话名称失败": "대화 이름 변경 실패",
    ...
    "展开文件列表": "파일 목록 펼치기",
    "工具输出": "도구 출력",
    "Discord 用户": "Discord 사용자",
    "飞书群": "Feishu 그룹",
    "飞书用户": "Feishu 사용자",
    "Telegram 频道": "Telegram 채널",
    "Telegram 用户": "Telegram 사용자",
    "微信群": "WeChat 그룹",
    "微信用户": "WeChat 사용자",
    "拥有者": "소유자",
    "非拥有者": "소유자 아님",
  ...
  "ja-JP": {
    ...
    "展开文件列表": "ファイル一覧を展開",
    "工具输出": "ツール出力",
    "Discord 用户": "Discord ユーザー",
    "飞书群": "Feishu グループ",
    "飞书用户": "Feishu ユーザー",
    "Telegram 频道": "Telegram チャンネル",
